...
def major(department, cource):
    if request.method == 'POST':
        ...
        if cource == 'ic':
            ...
            sum_credit['コース必修'] = subjects_sum([21120020, 21120070, 21120080, 21130020, 21210010, 21210040, 21210050, 21210070, 21210080, 21210090],  my_credits)
            ...
            sum_credit['コース必修'] = subjects_sum([21120020, 21120070, 21120080, 21220040, 21220070, 21220080, 21220110], my_credits)
            sum_credit['コース展開科目'] = subjects_sum([21320010, 21320020, 21320030, 21320040, 21320050, 21320060, 21320070, 21320080, 21320090, 21320100, 21320110, 21320120, 21320130, 21320140, 21320150, 21320160, 21320170, 21320180, 21320190, 21320200, 21320210], my_credits)
