...
def major(department, cource, chinese, common_sum):
    if request.method == 'POST':
        ...
        sum_credit['国際関係論'] = subjects_sum(requirements['国際関係論'], my_credits)
        ...
        lack_credit['学部教養科目（人文・社会）'] = max(0, 4 - sum_credit['学部教養科目（人文・社会）'])
        lack_credit['国際関係論'] = max(0, 2 - sum_credit['国際関係論'])
        ...
        lack_subject_ids['国際関係論'] = detect_lack_subject_ids(requirements['国際関係論'], my_credits)
